...
<html>
    ...
    <body>
        ...
        <div class='row'>
            <div class="col-lg-3">
                <button type="button" class="btn btn-block btn-info"><a href="EditProfile.jsp">Profile</a></button>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-3">
                <button type="button" class="btn btn-block btn-default"><a href="LogoutServlet">Log-Out</a></button>
            </div>
        </div>
        <br>
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <fieldset>
                            ...
                            <input type="text" class="form-control" name="bio" id="bio" placeholder="Tell us something about yourself">
                        </fieldset>
                    </div>            
                </div>
